...
class AppSizes {
  ...
  static double mainLabel = 11.sp;
  static double filterListElementTitle = 15.sp;
  static double cartHistoryProductCost = 18.sp;
  static double productOverviewTitle = 24.sp;
}